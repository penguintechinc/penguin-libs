...
class RedisCache:
    """Synchronous Redis cache backend using redis.Redis."""

    def __init__(self, config: RedisConfig) -> None:
        """Initialize Redis cache with given config."""
        try:
            import redis
...
class AsyncRedisCache:
    """Async Redis cache backend using redis.asyncio.Redis."""

    def __init__(self, config: RedisConfig) -> None:
        """Initialize async Redis cache with given config."""
        try:
