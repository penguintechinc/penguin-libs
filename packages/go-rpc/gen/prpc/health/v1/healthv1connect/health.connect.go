...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/penguintechinc/penguin-libs/packages/go-rpc/gen/prpc/health/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthServiceName = "prpc.health.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/prpc.health.v1.HealthService/Check"
	// HealthServiceWatchProcedure is the fully-qualified name of the HealthService's Watch RPC.
	HealthServiceWatchProcedure = "/prpc.health.v1.HealthService/Watch"
)

// HealthServiceClient is a client for the prpc.health.v1.HealthService service.
type HealthServiceClient interface {
	Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error)
	Watch(context.Context, *connect.Request[v1.CheckRequest]) (*connect.ServerStreamForClient[v1.CheckResponse], error)
}

// NewHealthServiceClient constructs a client for the prpc.health.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_prpc_health_v1_health_proto.Services().ByName("HealthService").Methods()
	return &healthServiceClient{
		...
		watch: connect.NewClient[v1.CheckRequest, v1.CheckResponse](
			httpClient,
...
type healthServiceClient struct {
	...
	watch *connect.Client[v1.CheckRequest, v1.CheckResponse]
}

// Check calls prpc.health.v1.HealthService.Check.
...
// Watch calls prpc.health.v1.HealthService.Watch.
func (c *healthServiceClient) Watch(ctx context.Context, req *connect.Request[v1.CheckRequest]) (*connect.ServerStreamForClient[v1.CheckResponse], error) {
	return c.watch.CallServerStream(ctx, req)
}

// HealthServiceHandler is an implementation of the prpc.health.v1.HealthService service.
type HealthServiceHandler interface {
	Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error)
	Watch(context.Context, *connect.Request[v1.CheckRequest], *connect.ServerStream[v1.CheckResponse]) error
}
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/prpc.health.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("prpc.health.v1.HealthService.Check is not implemented"))
}

func (UnimplementedHealthServiceHandler) Watch(context.Context, *connect.Request[v1.CheckRequest], *connect.ServerStream[v1.CheckResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("prpc.health.v1.HealthService.Watch is not implemented"))
}
