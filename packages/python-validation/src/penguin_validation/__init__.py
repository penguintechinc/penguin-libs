...
Usage:
    from penguin_validation import IsEmail, IsLength, chain
...
from penguin_validation.base import ValidationError, ValidationResult, Validator, chain
from penguin_validation.datetime import IsDate, IsDateInRange, IsDateTime, IsTime
from penguin_validation.network import IsEmail, IsHostname, IsIPAddress, IsURL
from penguin_validation.numeric import (
    IsFloat,
    IsFloatInRange,
    IsInt,
    IsIntInRange,
...
from penguin_validation.password import IsStrongPassword, PasswordOptions
from penguin_validation.string import (
    IsAlphanumeric,
    IsIn,
    IsLength,
    IsMatch,
