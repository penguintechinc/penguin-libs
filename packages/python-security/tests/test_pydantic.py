...
class TestOpenAPI:
    ...
    def test_generate_openapi_schema(self) -> None:
        ...
        from penguin_security.pydantic.openapi import generate_openapi_schema
...
class TestAsyncUtils:
    ...
    async def test_run_in_threadpool(self) -> None:
        ...
        from penguin_security.pydantic.async_utils import run_in_threadpool
    ...
    async def test_async_validator_register(self) -> None:
        ...
        from penguin_security.pydantic.async_utils import AsyncValidator
    ...
    async def test_validate_foreign_key_exists(self) -> None:
        ...
        from penguin_security.pydantic.async_utils import validate_foreign_key
    ...
    async def test_validate_unique_field(self) -> None:
        ...
        from penguin_security.pydantic.async_utils import validate_unique_field
