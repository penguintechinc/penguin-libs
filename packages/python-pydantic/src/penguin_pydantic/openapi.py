...
# Conditional import: flask_restx is optional
try:
    from flask_restx import fields as restx_fields
except ImportError:
    restx_fields = None  # type: ignore


def pydantic_to_restx_field(field_info: FieldInfo, annotation: Any) -> Any:
    ...
    """
    if restx_fields is None:
        raise ImportError("flask_restx is required for this function")
